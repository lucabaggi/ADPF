...
/**
 * Interface that has to be implemented in order to implement Ghost Mode
 *
 */
public interface GhostMode {
	
	/**
	 * Method that permits to enable Ghost Mode
	 */
	public void enableGhostMode();
	
	/**
	 * Method that permits to disable Ghost Mode
	 */
